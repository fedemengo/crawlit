...
func TestCreateURL(t *testing.T) {
	...
	path := "/some/path"
	testURL(t, "https://www.example.org/some/path", CreateURL(host, path))

	host = "https://www.example.org"
	path = "//example2.me/else"
	testURL(t, "https://example2.me/else", CreateURL(host, path))

	host = "https://www.example.org"
	path = "/something/else?x=y"
	testURL(t, "https://www.example.org/something/else", CreateURL(host, path))
